...
<head>
  <meta charset="utf-8">
  <title>Proyectos - Colina Verde</title>
...
<body>
  ...
  <div class="contenido">
    <div class="img_nosotros">
      <div class="menu_secundario">
        <?php 
          ...
          while($rs=mysql_fetch_array($sentencia,$mibase)){
        ?>
        <li><a href="proyectos.php?id=<?php echo $rs["id"] ?>"><?php echo $rs["nombre"] ?></a></li>
        <?php } ?>
      </div>
      <?php
          if($_GET[id] >0){ 
    ...
    <div class="texto">
      ...
      if ($_GET["id"]>0){
      $listado = "select * from detalleproyecto where id_proyecto ='$_GET[id]' ";
      }else {
            $listado = "select * from detalleproyecto where id_proyecto ='$iddd' ";
      }
      ...
      <div class="proyecto">
        <div class="img_proyecto">
          <img src="imagenes/proyectos/proyectos/<?php echo $rs["id"] ?>.jpg">
        </div>
        <h3><?php echo $rs["nombre_proyecto"] ?></h3>
        <a href="detalle_proyecto.php?id=<?php echo $rs["id"] ?>">ver detalle</a>
      </div>
      <?php } ?>

  ...
  <table width="287" border="1"  cellpadding="0">
    <tr>
      <td height="296"><table width="283" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" style="color:white;"><span class="logo" style="color:white;"><a href="nosotros.php" class="texto">Compañia</a></span></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" style="color:white;"><span class="logo" style="color:white;"><a href="servicios.php" class="texto">Servicios</a></span></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="texto" ><span class="logo" style="color:white;"><a href="proyectos.php" class="texto">Proyectos</a></span></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" ><span class="logo" style="color:white;"><a href="maquinaria.php" class="texto">Maquinaria</a></span></td>
        </tr>
        <tr>

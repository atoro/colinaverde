...
if ($_POST["Modificar"]){
	$insertar = "UPDATE maquinaria SET nombre ='".$_POST["nombre"]."',titulo ='".$_POST["titulo"]."'  WHERE id  = '" .$_GET["id"]."' " ; 
	$sentencia=mysql_query($insertar,$conn)or die("Error al grabar : ".mysql_error);


?>
<script language="javascript">
	window.opener.document.location="maquinaria.php"
	window.close();
	</script>	
<?php } ?>
...
?>
<form action="editarmaquinaria.php?id=<?php echo $_GET["id"]; ?>" method="post" name="form1" id="form1">
